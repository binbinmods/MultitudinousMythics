...
2. Open the `com.binbin.MultitudinousMythics.dll` file into the `Across the Obelisk\BepInEx\plugins` folder
3. Run the game
...
7. Close the game and copy the `MultitudinousMythics.dll` into the `Across the Obelisk\BepInEx\plugins` folder
